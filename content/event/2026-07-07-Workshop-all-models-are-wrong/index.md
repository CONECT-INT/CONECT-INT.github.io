...
subtitle: '"INT workshop : All models are wrong… but some are useful ! when vision meets audition to reinvent neuroscience"'
summary: '"INT workshop : All models are wrong… but some are useful ! when vision meets audition to reinvent neuroscience"'
---
...
* Where: salle [Henri Gastaut](https://fr.wikipedia.org/wiki/Henri_Gastaut) (ground floor), Institut de Neurosciences de la Timone (INT), 27 Boulevard Jean Moulin, 13005 Marseille](https://goo.gl/maps/MLpmsN9cd2N1Uv1L7).
